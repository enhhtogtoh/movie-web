...
//       updated = selected.filter((id) => id !== genreId);
//     } else {
//       updated = [...selected, genreId];
//     }
...
//       router.push("/genres");
//     } else {
//       router.push(`/genres?ids=${updated.join(",")}`);
//     }
//   };
...
//       <button
//         onClick={() => setOpen((prev) => !prev)}
//         className="flex items-center gap-2 rounded-md border border-[#E4E4E7]
//         bg-white px-4 py-2 text-sm hover:bg-[#432dd7] hover:text-white transition"
//       >
//         <ChevronDownIcon size={16} />
//         <span>Genre</span>
//       </button>
...
//             exit={{ opacity: 0, y: -10, scale: 0.96 }}
//             transition={{ duration: 0.25 }}
//             className="absolute left-1/2 top-10 z-40 w-[580px]
//             -translate-x-1/2 rounded-lg border bg-white p-6 shadow-lg"
//           >
//             <h2 className="text-xl font-semibold mb-1">Genres</h2>
//             <p className="text-sm text-gray-500 mb-4">Select multiple genres</p>
