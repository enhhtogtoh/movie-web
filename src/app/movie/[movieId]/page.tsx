...
//   return (
//     <div className="px-10 py-6 space-y-6 flex flex-col justify-center max-sm:px-0 ">
...
//       <div className="flex gap-8 justify-center items-center relative max-sm:flex-col-reverse max-sm:">
//         <img
...
//             className="rounded-lg w-190 h-107 max-sm:w-full max-sm:h-52.75"
//             alt="backdrop"
//           />
    ...
    <div className="max-w-7xl mx-auto px-4 max-sm:px-0 py-6 space-y-6 flex flex-col justify-center ">
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-8 items-start lg:items-center">
        ...
        <div className="relative w-full lg:order-2">
          <img
            src={`https://image.tmdb.org/t/p/original${data.backdrop_path}`}
            className="rounded-lg w-full h-52.75 sm:h-100 lg:h-112.5 object-cover max-sm:rounded-none"
            alt="backdrop"
          />
